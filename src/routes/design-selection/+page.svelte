...
<main class="mx-auto mb-10 mt-4 flex max-w-2xl flex-col px-4 sm:px-0">
  <div class="flex flex-col pb-4 text-center">
    <h1 class="mb-2 font-display text-3xl font-bold uppercase">Design Selection</h1>
  ...
  <figure>
    <div class="grid grid-cols-1 justify-center overflow-hidden rounded sm:grid-cols-2">
      <picture>
        ...
        <a href="images/design-option-1.webp" target="_blank">
          <picture>
            ...
            <img
              ...
              width="1280"
              height="853"
              class="rounded border transition-all hover:opacity-90"
            />
          </picture>
        </a>
      </div>
