	...
	<a href="/">
		<div class="flex justify-between bg-holdeman px-4 md:px-6 py-5 md:py-8 uppercase font-display">
			...
			<div class="flex flex-col">
				<span class="block w-full text-right md:text-2xl font-bold mt-auto md:mb-2">Est. 1998</span>
				<span class="block w-full text-right text-sm md:text-xl">holdemantempe.org</span>
			</div>
		</div>
	</a>
</div>
...
<main class="flex flex-col max-w-2xl mx-auto mt-4 mb-10 px-4 sm:px-0">
	<div class="flex flex-col text-center pb-4">
		<h1 class="text-3xl mb-2 font-display font-bold uppercase">Artist Selection</h1>
	...
	<p class="c1">
		<span class="c7"
			...
			wonderful and talented artists respond to our request for proposals, so choosing won&rsquo;t
			be easy. That&rsquo;s where you come in!</span
		>
	</p>
	<p class="c1 c9"><span class="c7"></span></p>
	<p class="c1">
